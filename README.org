...
* Notes: Sample tests are in main.cpp, funcs.cpp contains all 4 functions and
is commented fully. funcs.h contains the header functions from funcs.cpp.
There are tests for each function in tests.cpp
